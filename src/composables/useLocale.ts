...
const MESSAGES = {
  en: {
    ...
    'workLog.rejectedFromActivityPanel': 'Rejected from codex-web-local activity panel.',
  ...
  'zh-CN': {
    ...
    'workLog.rejectedFromActivityPanel': '已从 codex-web-local 活动面板驳回。',
    ...
    'approvalRisk.impact.noCommandPolicy': '此命令未配置 .codex-web.yml 允许列表或拒绝列表。',
