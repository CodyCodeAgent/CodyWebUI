...
const MESSAGES = {
  en: {
    ...
    'settings.tasks.title': 'Background tasks',
    'settings.tasks.subtitle': 'Inspect scheduled work, progress, deadlines, failures, and the next run.',
  ...
  'zh-CN': {
    ...
    'settings.tasks.title': '后台任务',
    'settings.tasks.subtitle': '查看定时任务的进度、超时、失败状态和下次执行时间。',
