...
.token-flame-button {
  @apply flex h-13 w-13 cursor-move flex-col items-center justify-center rounded-full border theme-border-warning bg-zinc-950 text-white shadow-xl transition hover:scale-105;
  touch-action: none;
}
